...
# 模型保存路径
test_pretrained_path = "/home/data/zhuchuanbo/Documents/competition/JHT/checkpoints/JHT/JHTModel_2022-10-25_16_57/best_model_0.pth" # this is shuffle_v2, using 2000 samples.
    ...
    with torch.no_grad():
        ...
        for file_temp, prediction_temp, test_logistic in zip(test_paths, test_predictions, test_logistics):
            ...
            if key in predictions.keys():
                if test_logistic[np.argmax(test_logistic)] <= 0.8:
        ...
        for key, value in predictions.items():
            ...
            file_name = os.path.join(email_files, "R_{}_{}.txt".format(key.split("_")[1], label_to_class[stats.mode(value)[0][0]]))
